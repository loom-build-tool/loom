...
public class LogXMLBugReporter extends XMLBugReporter {

    private static final Logger LOG = LoggerFactory.getLogger(LogXMLBugReporter.class);

    public LogXMLBugReporter(final Project project) {
        super(project);
    }
