    ...
    implements ScannerFilter
{
    ...
    public JUnit4TestChecker( final ClassLoader testClassLoader )
    {
    ...
    private boolean isValidJUnit4Test( final Class testClass )
    {
        ...
        {
            final Annotation runWithAnnotation = testClass.getAnnotation( runWith );
    ...
    private boolean lookForTestAnnotatedMethods( final Class testClass )
    {
    ...
    public boolean checkforTestAnnotatedMethod( final Class testClass )
    {
        for ( final Method lMethod : testClass.getDeclaredMethods() )
        {
            for ( final Annotation lAnnotation : lMethod.getAnnotations() )
            {
